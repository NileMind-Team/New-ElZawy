                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <input
                            ...
                            className="w-full border border-gray-200 bg-white text-black rounded-lg sm:rounded-xl pl-9 pr-3 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#E41E26] focus:border-transparent transition-all duration-200 text-sm sm:text-base disabled:bg-gray-100 disabled:cursor-not-allowed"
                      ...
                      <div>
                        ...
                        <div className="relative group">
                          ...
                          <div
                            ...
                            className="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-[#E41E26] cursor-pointer transition-colors duration-200 text-sm"
                          >
                          ...
                          <input
                            ...
                            className="w-full border border-gray-200 bg-white text-black rounded-lg sm:rounded-xl pl-9 pr-9 py-2.5 sm:py-3 outline-none focus:ring-2 focus:ring-[#E41E26] focus:border-transparent transition-all duration-200 text-sm sm:text-base"
                            placeholder={
                              editingId
